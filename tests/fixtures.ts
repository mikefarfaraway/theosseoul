...
export const sampleProfile: ProfileBundle = {
  ...
  introNote: "A private Seoul recommendation board.",
  guest: {
    name: "Sheila",
    role: "Guest of honor",
    shortBio: "Design-loving traveler.",
    heroImage: "/images/people/sheila-portrait.svg",
  },
  curator: {
    name: "Theo",
    role: "Curator",
    shortBio: "Mapped the mood.",
    heroImage: "/images/people/theo-portrait.svg",
  },
};
...
export const sampleSpot: Spot = {
  ...
  whyShellLikeIt: "Because it feels soft and personal.",
  bestTime: "Morning",
  priceLevel: "$$",
