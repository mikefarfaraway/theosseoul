  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-black/45">Theo&apos;s Google Map, as a quick preview</p>
          <p className="mt-2 text-lg font-semibold text-ink">A still poster for fast scanning on mobile</p>
          <p className="mt-1 text-sm leading-6 text-black/60">
            Tap once to open the full public Google Map in a new tab when you want the real zoom, pan, and saved-pin
            experience.
          </p>
        </div>
        <div className="text-sm text-black/50">{spots.length} spots in the current shortlist</div>
      </div>
      ...
      <div className="relative mt-4 overflow-hidden rounded-[24px] border border-black/10 bg-[#F7F6F2]">
        <div className="relative h-[420px]">
          ...
          <div className="absolute bottom-4 right-4 flex items-center gap-2 rounded-full border border-white/25 bg-white/18 px-4 py-2 text-sm font-medium text-white backdrop-blur-md">
            <span>Open Theo&apos;s map</span>
